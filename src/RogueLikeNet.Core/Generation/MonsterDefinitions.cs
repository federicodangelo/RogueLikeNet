...
/// <summary>
/// Monster templates indexed by type ID. All values are integers.
/// </summary>
public static class MonsterDefinitions
{
    ...
    public static readonly MonsterTemplate[] Templates =
    [
    ...
    /// </summary>
    public static MonsterTemplate Pick(SeededRandom rng, int difficulty)
    {
        // Higher difficulty unlocks harder monsters
        int maxIndex = Math.Min(difficulty + 1, Templates.Length - 1);
