...
public static class SkillDefinitions
{
    ...
    [
        new(PowerStrike, "Power Strike", 5, 200, 1),
        new(ShieldBash,  "Shield Bash",  8, 50,  1),
        new(Backstab,    "Backstab",     6, 300, 1),
        new(Dodge,       "Dodge",       10, 100, 1),
        new(Fireball,    "Fireball",     8, 150, 5),
        new(Heal,        "Heal",        12, 100, 1),
        new(PowerShot,   "Power Shot",   6, 180, 5),
        new(Trap,        "Trap",        15, 100, 3),
    ];
