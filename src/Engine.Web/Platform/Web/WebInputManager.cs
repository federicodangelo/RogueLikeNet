...
public class WebInputManager : BaseInputManager
{
    ...
    private readonly Dictionary<InputAction, List<InputBinding>> _bindings = new()
    {
        ...
        [InputAction.UseItem5] = [InputBinding.Key("Digit5")],
        [InputAction.UseItem6] = [InputBinding.Key("Digit6")],
        [InputAction.UseItem7] = [InputBinding.Key("Digit7")],
        [InputAction.UseItem8] = [InputBinding.Key("Digit8")],
